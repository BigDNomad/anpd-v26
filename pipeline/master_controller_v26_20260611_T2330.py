...
COMPONENTS: dict[str, str] = {
    ...
    "synopsis_generator":        "pipeline.synopsis_generator",
    "synopsis_auditor":          "pipeline.synopsis_auditor",
    "synopsis_summarizer":       "pipeline.synopsis_summarizer",
    "character_generator":       "pipeline.character_generator",
    "character_profile_auditor": "pipeline.character_profile_auditor",
    "scene_writer":              "pipeline.scene_writer",
    "scene_auditor":             "pipeline.scene_auditor",
    "state_tracker":             "pipeline.state_tracker",
    "scene_formatter":           "pipeline.scene_formatter",
    "manuscript_auditor":        "pipeline.manuscript_auditor_v25",
    "manuscript_assembler":      "pipeline.manuscript_assembler",
    "outline_comparator":        "pipeline.outline_comparator",
    "manuscript_summarizer":     "pipeline.manuscript_summarizer",
    "manifest_auditor":          "pipeline.manifest_auditor",
