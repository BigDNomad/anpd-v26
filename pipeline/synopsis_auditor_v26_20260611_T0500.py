...
[Q19] Are there exactly two resolution scenes?
- Resolution scenes are scenes that occur after the antagonist is neutralized
  and the central conflict is resolved
- FAIL if there are fewer than 2 or more than 2 resolution scenes
- Report exact count regardless of verdict"""
...
RUBRIC_METADATA = {
    ...
    "Q19": {"pass_name": "resolution_scene_count", "category": "structure",          "location_type": "whole_artifact", "suggested_fix": "Adjust resolution scenes to exactly two. Resolution scenes occur after antagonist neutralization and central conflict resolution."},
}
...
For Q19, count resolution scenes (scenes after antagonist neutralization and central conflict resolution). Report exact count.
...
def audit_synopsis(
    ...
    cmd = [
        sys.executable, "-m", "pipeline.synopsis_auditor_v26_20260611_T0500",
