"""
synopsis_generator.py — V25 Synopsis Generator
...
SCENE FORMAT:
### Scene N — Title [TYPE: ACTION|MIXED|NON-ACTION] [MODE: <if provided>] [FOCUS: <if provided>]
...
"""
    ...
    if is_scene_organized:
        ...
        type_line = "Tag each: ### Scene N — Title [TYPE: ACTION|MIXED|NON-ACTION] [MODE: <if provided>] [FOCUS: <if provided>]"
